...
You grant the Owner and recipients of the software a **perpetual, worldwide, non-exclusive,
royalty-free, irrevocable** patent license to make, use, sell, offer to sell, import, and
otherwise transfer your Contribution, for patent claims you can license that are necessarily
infringed by your Contribution alone or combined with the Project.
...
- each Contribution is your original work, or you have the right to submit it under this CLA;
- your Contribution does not knowingly include third-party code under terms incompatible with the
  Project's licensing, and you identify any third-party material and its license in the
  Contribution;
- to your knowledge, your Contribution does not violate any third party's rights;
- if your employer has rights to work you create, you have permission to contribute, or your
  employer has waived such rights for the Project.

## 6. No obligation; no warranty

You understand the Owner is not obligated to use or merge your Contribution. Except for the
licenses granted here, the Contribution is provided **"as is" without warranty of any kind**, to
the extent permitted by law.

---

**How to accept:** opening a pull request against this repository constitutes acceptance of this
CLA for the Contribution(s) in it. The maintainer may also ask you to confirm acceptance in the
pull request.
