...
inline std::string searchDictString(io_registry_entry_t e, const char* dictKey, const char* itemKey)
{
    CFStringRef dk = CFStringCreateWithCString(nullptr, dictKey, kCFStringEncodingUTF8);
    CFTypeRef prop =
        IORegistryEntrySearchCFProperty(e, kIOServicePlane, dk, kCFAllocatorDefault,
